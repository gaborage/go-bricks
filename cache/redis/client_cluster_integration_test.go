...
// TestRealRedisClusterModeStatsAndHealth pins what a /ready reader sees. The
// mode key is what tells it how to read the rest: redis_info comes from
// whichever single node answered INFO, and the pool counters are the aggregate
// across every master's pool.
