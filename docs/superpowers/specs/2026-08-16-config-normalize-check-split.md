...
| 11 | Cross-section first-error precedence **changes** (a phase-1 database error now precedes a phase-2 app-name error). Accepted; intra-section order preserved. | No ADR/atom promises cross-section first-error. Verified in PR1 that no test pins one; commit body records the change. |
