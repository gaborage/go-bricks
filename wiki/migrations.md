...
- scope: [C60.16] addressed a database section's errors to that section at the STARTUP doors
  ...
  E61 hop by `[C61.24]`, which rejects such a name at startup — on THIS hop they still boot
...
### [C61.24] a user-named config section must be reachable by an environment variable · breaking · when: match
