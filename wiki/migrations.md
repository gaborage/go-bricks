...
- scope: none of these were ever called by the framework's own consumers — they were
  ...
  their new unexported home. Two log lines are the exception: `LogDeploymentMode`'s INFO
  ...
  pre-warming`) retire outright with no renamed equivalent — the deployment mode and
