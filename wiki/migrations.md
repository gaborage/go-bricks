...
## E63 · v0.62.0 → v0.63.0 — the typed publish door replaces raw byte publishing + header-sourced event ids are validated before the inbox ledger
