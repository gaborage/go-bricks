...
- apply: nothing in application code. Repoint an alert or a log query matching the old ERROR
  ...
  `Observability shutdown failed; telemetry may have been lost`, and drop any test that
  asserts a non-zero exit for a downed collector. To KEEP the telemetry rather than merely
