...
## E64 · v0.63.0 → v0.64.0 — both `SetMap` doors order their columns by the caller's names and the JoinFilter family spells inequality `<>` + the JOSE error envelope gates its `details` like every other renderer
