...
- note: New exported surface, all additive: `DbManager.Remove(key string) error`,
  ...
  `cache.ManagerStats{…}` literal stops compiling and the compiler names it; a KEYED literal is
  unaffected. Semantics and the rotation recipe:
