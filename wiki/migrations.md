...
- scope: the key is renamed, not retired. It counted tenant keys holding a consumer registry — one
  for a single-tenant service, whatever its consumer count — and that count is now
