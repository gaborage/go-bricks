...
## E65 · v0.64.0 → v0.65.0 — `BuildUpsert` preconditions become matchable sentinels + a unix-socket PostgreSQL host refuses the TLS it cannot carry + the inbox ledger key is typed by the door that produced it
