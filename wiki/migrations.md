...
- ref: ADR-049 · `app/debug_handlers.go` (`RegisterDebugEndpoints`, `exposedEndpoints`, `ipWhitelistMiddleware`) · `app/lifecycle.go` (`registerDebugHandlers`)
