...
fatal at startup: the process boots, the cache pre-init (`Builder.preInitCache` then; `Builder.performPreInitialization`
over the cache slot since [ADR-067](adr_067_lifecycle_slots.md)) logs a WARN, and the pod simply
