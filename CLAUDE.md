...
- **messaging/** — RabbitMQ AMQP client. `messaging/streams` consumes/publishes natively (5552): server-side offsets after success, handlers inline/sequential, SAC; publish sync-confirmed, super streams hash-routed; single-tenant ([streams.md](wiki/streams.md), ADR-059/063).
