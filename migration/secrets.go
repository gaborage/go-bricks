...
// numeric and bool fields through the delivered-empty guard — a rotated secret rendering
// {"port": ""} would otherwise dial port 0 (ADR-074) and one rendering
// {"pool":{"keepalive":{"enabled":""}}} would turn TCP keep-alive off (ADR-077). TagName
